...
<html>
    <head>
      	...
      	<?php
      		$wp_head = get_option( 'faeasypdf_print_wp_head', '' );
      		if( $wp_head == 'on' ) {
      			wp_head();
      		}
      	?>
          ...
          .fa {
			...
			<?php
				...
				$css = get_option( 'faeasypdf_pdf_custom_css', '' );
				echo $css;
			?>
    ...
    <body>
	    ...
	    if( $post_type == 'attachment') { ?>
		    ...
		    $the_query = new WP_Query( apply_filters( 'faeasypdf_query_args', $args ) );

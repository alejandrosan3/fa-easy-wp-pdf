...
<?php 
	global $post;
	$pdf_footer_text = sanitize_option( 'faeasypdf_pdf_footer_text', get_option( 'faeasypdf_pdf_footer_text' ) );
	$pdf_footer_show_title = sanitize_option( 'faeasypdf_pdf_footer_show_title', get_option( 'faeasypdf_pdf_footer_show_title' ) );
	$pdf_footer_show_pagination = sanitize_option( 'faeasypdf_pdf_footer_show_pagination', get_option( 'faeasypdf_pdf_footer_show_pagination' ) );
?>
		    ...
		    <div style="float:right;text-align:right;">
				...
				<?php
					...
					if ( $pdf_footer_show_pagination ) {
						...
						echo apply_filters( 'faeasypdf_footer_pagination', '| {PAGENO}' );

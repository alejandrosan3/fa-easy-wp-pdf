...
<?php 
  	global $post;
  	$pdf_header_image = sanitize_option( 'faeasypdf_pdf_header_image', get_option( 'faeasypdf_pdf_header_image' ) );
    $pdf_header_image_attachment = wp_get_attachment_image_src( $pdf_header_image, 'full' );
    $pdf_header_show_title = sanitize_option( 'faeasypdf_pdf_header_show_title', get_option( 'faeasypdf_pdf_header_show_title' ) );
    $pdf_header_show_pagination = sanitize_option( 'faeasypdf_pdf_header_show_pagination', get_option( 'faeasypdf_pdf_header_show_pagination' ) );
?>
			...
			<div style="width:75%;float:right;text-align:right;height:35px;padding-top:20px;">
				...
				<?php
					...
					if ( $pdf_header_show_title ) {
						...
						echo apply_filters( 'faeasypdf_header_title', get_the_title( $post->ID ) );
				...
				<?php
					...
					if ( $pdf_header_show_pagination ) {
						...
						echo apply_filters( 'faeasypdf_header_pagination', '| {PAGENO}' );
